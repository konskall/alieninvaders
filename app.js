...
class Game {
    ...
    showShareDialog() {
        ...
        let message = '';
        if (level <= 10) {
            message = `Επιβίωσα Level ${level}/100 από το πρώτο κύμα της επίθεσης! 👽`;
        } else if (level <= 25) {
            message = `Έφτασα στο καταφύγιο ${level}/100 with ${score} πόντους! 🛸`;
        } else if (level <= 50) {
            message = `Ξεκίνησα την αντεπίθεση ${level}/100 - ${score} πόντους! 💪`;
        } else if (level <= 75) {
            message = `Οι εξωγήινοι πλέον με τρέμουν - Έφτασα Level ${level}/100! ${score} πόντους! 🔥`;
        } else {
            message = `Οι εξωγήινοι ηττήθηκαν - Έφτασα Level ${level}/100! Μπορείς να με φτάσεις; ${score} πόντους? 🚀`;
        }
        ...
        const dialogHTML = `
            <div id="share-dialog" class="share-dialog">
                <div class="share-content">
                    <h2><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="#f1c40f" viewBox="0 0 24 24">
  <path d="M12 2l2.39 6.91L22 10l-5 3.64L17.78 22 12 18.27 6.22 22 7 13.64 2 10l7.61-1.09L12 2z"/>
</svg> Κοινοποίηση Σκορ <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="#f1c40f" viewBox="0 0 24 24">
  <path d="M12 2l2.39 6.91L22 10l-5 3.64L17.78 22 12 18.27 6.22 22 7 13.64 2 10l7.61-1.09L12 2z"/>
</svg></h2>
